...
<body>
<form action=updateDir method=post enctype="multipart/form-data" class="form-horizonal">
<table border="1">
<tr>
<th>Id</th>
<td>경로</td>
...
<c:otherwise>
<img src='<c:url value="/resources/images/thumbnail.jpeg"/>' width="100" class="img-thumbanail">
</c:otherwise>
</c:choose>
</td>
<td>${file.userId}</td>
