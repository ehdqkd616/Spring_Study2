...
파일 이름 : <img src='<c:url value="/img/${file.fileId}"/>' width="100" class="img-thumbnail">
<a href='<c:url value="/pds/${file.fileId}" />'>${file.fileName}</a><br>
</c:when>
<c:otherwise>
파일 이름 : <img src='<c:url value="/resources/images/thumbnail.jpeg"/>' width="100" class="img-thumbanail">
<a href='<c:url value="/pds/${file.fileId}" />'>${file.fileName}</a><br>
</c:otherwise>
</c:choose>
파일 작성자 : ${file.userId}<br>
